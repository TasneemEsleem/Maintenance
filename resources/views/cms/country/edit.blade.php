...
@section('page-md',__('cms.edit_country'))
@section('styles')
            ...
            <form id="create-form" class="form fv-plugins-bootstrap5 fv-plugins-framework" >
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" id="name_ar" value="{{$country->name_ar}}" >
                        <!--end::Input-->
                 ...
                 <div class="col-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" id="name_en" value="{{$country->name_en}}" >
                        <!--end::Input-->
                    <div class="fv-plugins-message-container invalid-feedback"></div></div>
                 </div>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="button" onclick="performUpdate('{{$country->id}}')" class="btn btn-primary">
...
formData.append('name_en',document.getElementById('name_en').value);  
    formData.append('_method','PUT');
      axios.post('/cms/countries/{{$country->id}}', formData)
